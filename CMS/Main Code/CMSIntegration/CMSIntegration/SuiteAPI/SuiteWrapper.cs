...
namespace CMSIntegration.SuiteAPI
{
    public static class SuiteWrapper
    {
        ...
        //public static async Task<string> Oauth2Login()
        //{
        //    var dObj = new
        //    {
        //        grant_type = "password",
        ...
        //        platform = "CMS_Integration"

        //    };

        //    string jstr = await CallApiOauth2Login(dObj).ConfigureAwait(false);
        //    dynamic res = JsonConvert.DeserializeObject(jstr);
        //    return res.id.Value;
        //}

        //private static async Task<string> CallApiOauth2Login(object dObj)
        //{
        //    // Serialize our concrete class into a JSON String
        //    var stringPayload = JsonConvert.SerializeObject(dObj);

        //    // Wrap our JSON inside a StringContent which then can be used by the HttpClient class
        //    var httpContent = new StringContent(stringPayload, Encoding.UTF8, "application/json");

        //    HttpClient client = new HttpClient();
        //    client.BaseAddress = new Uri("http://192.168.97.179/pundolesdev1/rest/v10");
        ...
        //public class C1
        //{
        //    public C2[] relationship_list { get; set; }
        //}

        //public class C2
        //{
        //    public C3[] link_list { get; set; }
        //}

        //public class C3
        //{
        //    public string name { get; set; }
        //    public C4[] records { get; set; }
        //}
        ...
        public static async Task<ReadEntryListResponse> GetList(ReadEntryListRequest req)
        {
            ...
            try
            {
                ...
                //var ds = JsonConvert.DeserializeObject<C1>(jstr);
            }
            catch (Exception ex)
            {
        ...
        public static List<T> GetListObjectConvertedforRelationShip<T>(JObject jObjectData)
        {
            var strList = "[" + Convert.ToString(jObjectData) + "]";
            return ToObjects<T>(strList);
        }
